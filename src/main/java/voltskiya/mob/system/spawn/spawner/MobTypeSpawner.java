package voltskiya.mob.system.spawn.spawner;

import apple.utilities.json.gson.GsonBuilderDynamic;
import java.util.ArrayList;
import java.util.List;
import voltskiya.mob.system.spawn.spawner.context.SpawningContext;
import voltskiya.mob.system.spawn.spawner.modifier.SpawningModifierFactory;
import voltskiya.mob.system.spawn.spawner.modifier.PreSpawningModifierFactory;
import voltskiya.mob.system.spawn.spawner.rule.generic.SpawningRule;
import voltskiya.mob.system.spawn.spawner.rule.old.BlockConditionsTypes;
